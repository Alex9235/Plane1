...
namespace Decoder
{
    public class Plane
    {
        ...
        public Plane(int N, int M, int P, double n, double m, double p)//
        {
        ...
        private void LoadTFULL(String PathTemp)
        {
            double r = lam1 * lam1;
            ...
            for (int z = 0; z < P; z++)
                ...
                for (int y = 0; y < M; y++)
                {
                    ...
                    foreach (var number in s.Split())
                    {
                        if (number != "")
                        {
                            T[x, y, z] = Convert.ToDouble(number) * alf[x, y, z] * r;
                            x++;
                        }
                    }
                }
